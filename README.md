...
A simple gulp plugin, used to convert image(png|jpg|gif)，audio(mp3|m4a|ogg|wav|wma)，video(mp4|webm), ttf/svg into base64 string.
...
```
	{
		...
		file name : {base64: base64 encode}
	}
```	
